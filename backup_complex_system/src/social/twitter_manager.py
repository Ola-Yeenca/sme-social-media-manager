...
class TwitterManager:
    ...
    def __init__(self, api_credentials: Dict[str, str]):
        ...
        # Simple rate limiting (tweepy handles this automatically)
        # Removed complex tracking - using tweepy's wait_on_rate_limit=True
    ...
    # Removed complex rate limiting infrastructure
    # tweepy.Client with wait_on_rate_limit=True handles this automatically
    ...
    async def search_tweets(self, query: str, max_results: int = 10, 
        ...
        try:
            # Direct API call - tweepy handles rate limiting
            tweets = _search_tweets_internal()
    ...
    async def get_mentions(self, max_results: int = 20, since_time: Optional[datetime] = None) -> List[Tweet]:
        ...
        try:
            # Direct API call - tweepy handles rate limiting
            mentions = _get_mentions_internal()
